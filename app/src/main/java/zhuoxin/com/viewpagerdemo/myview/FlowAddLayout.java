...
public class FlowAddLayout extends ViewGroup implements View.OnClickListener{
    private Set<String> set;
    private Set<String> setAll;
    ...
    public FlowAddLayout(Context context) {
        this(context, null);
    }
    public FlowAddLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public FlowAddLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void getSetData(Set<String> setAll){
        this.setAll=setAll;
        removeAllViews();
    ...
    public void onClick(View v) {
        set = sharedpres.getSets(getContext());
        set.add((String)((TextView)v).getText());
        sharedpres.saveSets(set,getContext());
        setAll.remove(((TextView)v).getText());
        sharedpres.saveSetAll(setAll,getContext());
        removeView(v);
        if(deleteInterface!=null){
            deleteInterface.deleteData();//接口
        }}
}
